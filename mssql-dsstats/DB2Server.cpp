...
char * DB2Server::data_type(SQLSMALLINT dt)
{
    ...
    // SqlServer else if (dt == SQL_BLOB) strcpy(dtc, "SQL_BLOB");
    // SqlServer else if (dt == SQL_BLOB_LOCATOR) strcpy(dtc, "SQL_BLOB_LOCATOR");
    ...
    // SqlServer else if (dt == SQL_CLOB) strcpy(dtc, "SQL_CLOB");
    // SqlServer else if (dt == SQL_CLOB_LOCATOR) strcpy(dtc, "SQL_CLOB_LOCATOR");
    // SqlServer else if (dt == SQL_DATALINK) strcpy(dtc, "SQL_DATALINK");
    else if (dt == SQL_TYPE_DATE) strcpy(dtc, "SQL_TYPE_DATE");
    // SqlServer else if (dt == SQL_DBCLOB) strcpy(dtc, "SQL_DBCLOB");
    // SqlServer else if (dt == SQL_DBCLOB_LOCATOR) strcpy(dtc, "SQL_DBCLOB_LOCATOR");
    ...
    // SqlServer else if (dt == SQL_GRAPHIC) strcpy(dtc, "SQL_GRAPHIC");
    ...
    // SqlServer else if (dt == SQL_LONGVARGRAPHIC) strcpy(dtc, "SQL_LONGVARGRAPHIC");
    ...
    // SqlServer else if (dt == SQL_VARGRAPHIC) strcpy(dtc, "SQL_VARGRAPHIC");
...
bool DB2Server::Bind(int col_num, void *bind_var, SQLINTEGER bind_len)
{
    ...
    SQLSMALLINT nl;
    SQLSMALLINT dt;
	SQLULEN cs; // SQLUINTEGER cs; 2017-07-21 Compiling with odbc library and include from folder /usr 
    SQLSMALLINT dd;
    SQLSMALLINT n;
